                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div class="accordion-body">
                                                <p>It is a long established fact that a reader will be distracted by the readabl content of a page when looking at its layout. The point of using Lorem Ips  um is that it has a more</p>
                                            </div>
                                            </div>
                                        </div>
                                        <!-- Single 02 -->
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div class="accordion-body">
                                                <p>See how we’re building a better healthcare experience for people just like you. Search for a Clinicity Clinic health expert by specialty, disease. Quo ex facer decore sadipscing, mel cu iriure oporteat.</p>
                                            </div>
                                            </div>
                                        </div>
                                        <!-- Single 03-->
